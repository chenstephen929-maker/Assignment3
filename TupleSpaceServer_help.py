...
def handle_client(client_socket):
    ...
    try:
        while True:
            ...
            rest_bytes=receive_n(client_socket,message_size-3)
            if not rest_bytes:
                break

            message_buffer=rest_bytes.decode('utf-8').lstrip()
            ...
            fomat_response=f"{total_size}{response}"
            client_socket.sendall(fomat_response.encode('utf-8'))
